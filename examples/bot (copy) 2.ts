...
botBaileys.on('message', async (message) => {
    ...
    if (!awaitingResponse) {
        ...
        await botBaileys.sendPoll(message.from, 'Welcome to Pharmalite! Please choose a service by typing the corresponding number:\n\n or ' +
            '1️⃣ *Pharmalite E-learning*\n' +
            '2️⃣ *Pharmalite Blog*\n' +
            '3️⃣ *Pharma Jobs*\n' +
            '4️⃣ *Pharmalite AI*\n' +
            '5️⃣ *GPAT Help (Sponsored)*\n' +
            '6️⃣ *Pharmalite YouTube*\n' +
            '7️⃣ *Pharmalite Social Media*\n\n' +
            'Type *0* at any time to go back to the main menu.',
            {
                options: ['Pharmalite E-learning', 'Pharmalite Blog', 'Pharma Jobs', 'Pharmalite AI', 'GPAT Help (Sponsored)', 'Pharmalite YouTube', 'Pharmalite Social Media'],
                multiselect: false
            }
        );
